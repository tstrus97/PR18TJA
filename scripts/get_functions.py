...
def get_player_friends(id, api_key = "5F5DD2FA8A6C8646FCFE265C07BB90E5"):
    try:
...
def get_owned_games(id,  api_key = "5F5DD2FA8A6C8646FCFE265C07BB90E5"):
    try:
...
def get_achievements_for_player_game(id, appid,  api_key = "5F5DD2FA8A6C8646FCFE265C07BB90E5"):
